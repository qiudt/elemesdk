...
class ActivityService extends RpcService
{
    ...
    {
        return $this->client->call("eleme.activity.shippingFee.create", array("request" => $request));
    }
    ...
    {
        return $this->client->call("eleme.activity.shippingFee.update", array("request" => $request));
    }
    ...
    {
        return $this->client->call("eleme.activity.shippingFee.offline", array("request" => $request));
    }
    ...
    {
        return $this->client->call("eleme.activity.shippingFee.query", array("request" => $request));
    }
